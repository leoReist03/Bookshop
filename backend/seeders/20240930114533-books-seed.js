...
module.exports = {
  async up (queryInterface, Sequelize) {
    return queryInterface.bulkInsert('Books', [
      {
        id: uuidv4(),
        cover: 'https://res.cloudinary.com/dtsrisryl/image/upload/f_auto,q_auto/v1/books/redRising',
        name: 'Red Rising',
      ...
      {
        id: uuidv4(),
        cover: 'https://res.cloudinary.com/dtsrisryl/image/upload/f_auto,q_auto/v1/books/wayOfKings',
